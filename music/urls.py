...
urlpatterns = [
    ...
    path('api/radio/', views.api_radio, name='api_radio'),
    path('api/radio/current/', views.api_radio_current, name='api_radio_current'),
    path('login/', views.user_login, name='user_login'),
    path('logout/', views.user_logout, name='user_logout'),
    path('lang/<str:lang>/', views.set_language, name='set_language'),
    path('contact/', views.contact_submit, name='contact_submit'),
    path('api/lookup-cui/', views.lookup_cui, name='lookup_cui'),
